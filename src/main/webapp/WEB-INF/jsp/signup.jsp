        ...
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            <form action="/signup" method="post">
                <div data-mdb-input-init class="form-group mb-4">
                    <input name="firstName" type="text" id="form3Example3" class="form-control form-control-lg"
                           placeholder="Enter your firstName" style="width: 300px;" />
                </div>

                <div data-mdb-input-init class="form-group mb-4">
                    <input name="lastName" type="text" id="form3Example6" class="form-control form-control-lg"
                ...
                <div class="text-center text-lg-start">
                    ...
                    <p class="small fw-bold mt-2 pt-1 mb-0">already have an account? <a href="/" class="text-danger">log in</a></p>
                </div>
            </form>
        </div>
    </div>
